 ...
 * Resultado esperado: Poder = 72 - Nivel = 12 - Bicho Coins restante = 250.0
 */
public class RegistroGremio {
    public static void main(String[] args) {
        ...
        double bichoCoinsInscripcion = 50;
        double bichoCoinsRestante = bichoCoins - bichoCoinsInscripcion;
        ...
        System.out.println("Bicho Coins tras pagar inscripcion (" + bichoCoinsInscripcion + "): " + bichoCoinsRestante);
        System.out.println("*********************************");
